# Generated by Django 4.0 on 2023-02-06 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.BinaryField(editable=True, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='store.product')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders', models.ManyToManyField(related_name='orders_invoice', to='store.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
